      ...
      <div className="individual-detail-hotel-container">
        ...
        <div className="indi-hotel-display">
          <div className="w-full flex p-2 ">
            ...
            <div className="indi-hotel-carousel-side">
              <div className="w-full text-left p-2 border border-black rounded mb-3">
                <h4 className="text-base font-semibold ">Luxe TwinRoom</h4>
                <div className="ml-2 mt-2">
                  <p>
                    ...
                    <span className="text-xs">For 2 Adults</span>
                  </p>
                </div>
                <div className="ml-2  mt-2">
                  <span className="mr-2">
                ...
                <div className="ml-2 mt-1">
                  ...
                  <span className="text-red-500">Not Refundable</span>
                </div>
              </div>
              ...
              <div className="flex justify-between">
                ...
                <div className="width-set border border-black rounded p-2 text-left">
                  <div className="bg-blue-600 text-white font-semibold w-10 h-10 flex justify-center items-center text-lg rounded-md">
                    4.0
                  </div>
          ...
          <div className="indi-hotel-heading">
            <div className="text-3xl font-bold text-black ml-1">
              {hotel?.data?.name}
            </div>
            <div>
              <span>
            ...
            <div className="indi-room">
              <div className="w-full border border-black h-40 flex">
                <div className="w-3/5 border-r border-black p-3">
                  ...
                  <div>
                    <p className="flex gap-x-5 ml-2 mt-1  w-1/3">
                    ...
                    <p className="flex gap-x-5 ml-2 mt-1  w-1/2">
                      <span className="w-1/8">
                        <img
                  ...
                  <p className="mt-4 ml-3 text-blue-400">{`${room.cancellationPolicy}*`}</p>
                </div>
                <div className="w-2/5 border-r border-black p-2">
                  <h3 className="text-xl bg-gray-100 font-semibold px-2">
                    Prices
                  </h3>
                  <div className="px-3 py-2">
                    <p className="text-xs text-gray-500">per Night</p>
                    <div className="text-lg font-semibold ">{`₹ ${room.costDetails.baseCost}`}</div>
                    <div className="text-xs font-semibold">{`+ ₹ ${room.costDetails.taxesAndFees} taxes & fees`}</div>
                  </div>

                  <Link to={`/hotels/bookingpage/${hotel?.data?._id}`}>
                  <div className="indi-hotel-select-room" onClick={() => updateSetPrice(room.costDetails.baseCost , room.costDetails.taxesAndFees )}>Select room</div>
                  </Link>
                </div>
              </div>
            </div>
