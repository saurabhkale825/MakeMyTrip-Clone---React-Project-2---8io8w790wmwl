    ...
    <div className="navbar-details">
      <div className="navbar-details-left">
        ...
        <div className="navbar-details-options">
          <Link to={"/"}>
          <div className="navbar-details-options-tab" onClick={() => setMode("Flights")}>
            <div className="navbar-details-options-tab-image" >
              {mode === "Flights" ? (
                <img src={FlightsSelected} alt="logo" width="30px" height='20px'/>
              ) : (
          ...
          <Link to={"/hotels"}>
          <div className="navbar-details-options-tab" onClick={() => setMode("Hotels")}>
            <div className="navbar-details-options-tab-image">
              {mode === "Hotels" ? (
                <img src={HotelSelected} alt="logo" width="30px" height='20px'/>
              ) : (
          ...
          <Link to={"/"}>
          <div className="navbar-details-options-tab" onClick={() => setMode("HomeVillas")}>
            <div className="navbar-details-options-tab-image">
              {mode === "HomeStay" ? (
                <img src={HomeStaySelected} alt="logo" width="30px" height='20px'/>
              ) : (
          ...
          <Link to={"/"}>
          <div className="navbar-details-options-tab" onClick={() => setMode("Holiday")}>
            <div className="navbar-details-options-tab-image">
              {mode === "Holiday" ? (
                <img src={HolidaySelected} alt="logo" width="30px" height='20px'/>
              ) : (
          ...
          <Link to={"/trains"}>
          <div className="navbar-details-options-tab" onClick={() => setMode("Trains")}>
            <div className="navbar-details-options-tab-image">
              {mode === "Trains" ? (
                <img src={TrainsSelected} alt="logo" width="30px" height='20px'/>
              ) : (
          ...
          <Link  to={"/buses"}>
          <div className="navbar-details-options-tab" onClick={() => setMode("Buses")}>
            <div className="navbar-details-options-tab-image">
              {mode === "Buses" ? (
                <img src={BusesSelected} alt="logo" width="30px" height='20px'/>
              ) : (
          ...
          <Link to={"/"}>
          <div className="navbar-details-options-tab" onClick={() => setMode("Cabs")}>
            <div className="navbar-details-options-tab-image">
              {mode === "Cabs" ? (
                <img src={CabsSelected} alt="logo" width="30px" height='20px'/>
              ) : (
          ...
          <Link to={"/"}>
          <div className="navbar-details-options-tab" onClick={() => setMode("Forex")}>
            <div className="navbar-details-options-tab-image">
              {mode === "Forex" ? (
                <img src={ForexSelected} alt="logo" width="30px" height='20px'/>
              ) : (
