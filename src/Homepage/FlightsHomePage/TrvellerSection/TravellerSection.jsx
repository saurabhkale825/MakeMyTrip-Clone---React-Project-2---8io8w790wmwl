...
function TravellerSection() {
  ...
  const {traveller , setTraveller ,selectedClass, setSelectedClass} = useContext(FlightContext);
  ...
  return (
    <div className="traveller-section">
        ...
        <div className="traveller-section-adults-div">
          <span>
            <ol className="traveller-section-adults-number">
              <li
                id="1"
                onClick={() => setSelectedAdults(1)}
                className={
                  selectedAdults === 1
                    ? "traveller-section-adults-number-li-selected"
                    : "traveller-section-adults-number-li"
                }
              >
                1
              </li>
          ...
          <span
            className={
              selectedAdults === 10
                ? "traveller-section-adults-number-morethan-selected"
                : "traveller-section-adults-number-morethan"
            }
          >
            <p onClick={() => setSelectedAdults(10)}>{`>9`}</p>
          </span>
        </div>
      </div>
        ...
        <div className="traveller-section-second-options-content">
          ...
          <div className="traveller-section-children-div">
            <span>
              <ol className="traveller-section-children-number">
                <li
                  className={
                    selectedChildren === 0
                      ? "traveller-section-children-number-li-selected"
                      : "traveller-section-children-number-li"
                  }
                  onClick={() => setSelectedChildren(0)}
                >
                  0
                </li>
                <li
            ...
            <span
              className={
                selectedChildren === 6
                  ? "traveller-section-children-morethan-selected"
                  : "traveller-section-children-morethan"
              }
              onClick={() => setSelectedChildren(6)}
            >{`>6`}</span>
          </div>
        </div>
        <div className="traveller-section-second-options-content">
      ...
      <div className="traveller-section-error-div">
        {selectedInfants > selectedAdults ? (
          <>Number of infants cannot be more than adults </>
        ) : null}
      </div>
      <div className="traveller-section-apply-button" onClick={handleApply}>
        Apply
      </div>
    </div>
  );
